...
WELCOME: str = (
    ...
    "برای عضویت داخل VIP روی گزینه عضویت کلیک کنید.\n\n"
    "به علاوه ثبت نام رایگان؛ تا چند هزار دلار بونوس "
    "از طرف ما دریافت کن ✌️"
)
...
KICK_MSG: str = (
    ...
    "به دلیل پایین‌بودن موجودی در سه بررسی و دریافت سه هشدار، "
    "دسترسی شما به کانال حذف شد.\n\n"
    "━━━━━━━━━━━━━━\n"
    "💰 موجودی فعلی:\n"
    "{balance} USDT\n\n"
    "حداقل موجودی لازم:\n"
...
WARNING_MSG: str = (
    ...
    "حداقل موجودی:\n"
    "{min_balance} USDT\n\n"
    "پس از سه هشدار، اگر در بررسی بعدی موجودی همچنان کمتر از "
    "{min_balance} باشد، دسترسی VIP حذف خواهد شد.\n\n"
    "لطفاً موجودی خود را افزایش دهید."
)

TRIAL_INACTIVE: str = (
    "❌ سیستم VIP آزمایشی در حال حاضر غیرفعال است."
)

TRIAL_SUCCESS: str = (
    "🎁 VIP آزمایشی یک ساعته شما فعال شد.\n\n"
    "🔗 لینک یکبارمصرف ورود به کانال:\n"
    "{invite_link}\n\n"
    "⏳ دسترسی شما یک ساعت پس از فعال‌سازی به‌صورت خودکار حذف می‌شود."
)

TRIAL_ALREADY_ACTIVE: str = (
    "⏳ VIP آزمایشی شما در حال حاضر فعال است."
    "{invite_text}"
)

TRIAL_ALREADY_USED: str = (
    "❌ شما در این دوره قبلاً از VIP آزمایشی استفاده کرده‌اید."
)

TRIAL_PAID_VIP: str = (
    "✅ عضویت VIP اصلی شما فعال است و نیازی به VIP آزمایشی ندارید."
)

TRIAL_EXPIRED: str = (
    "🎁 VIP آزمایشی شما به پایان رسید\n\n"
    "⛔ دسترسی شما به کانال VIP بسته شد.\n\n"
    "📌 برای ادامه استفاده:\n"
    "- ثبت‌نام در صرافی\n"
    "- واریز حداقل مقدار مورد نیاز\n"
    "- ارسال UID به ربات"
)
...
VIP_REMINDER: str = (
    "⚠️ هشدار مهم!\n\n"
    "شما هنوز در VIP عضو نشده‌اید ❌\n"
    "و در حال از دست دادن سودها و سیگنال‌های مهم هستید 📉\n\n"
    "🔥 همین حالا UID خود را ارسال کنید و وارد VIP شوید!"
)

ADMIN_REMINDER_STARTED: str = (
    "⏳ ارسال یادآوری برای کاربران غیرVIP شروع شد..."
)

ADMIN_REMINDER_RESULT: str = (
    "✅ ارسال یادآوری تمام شد.\n\n"
    "کل کاربران غیرVIP: {total}\n"
    "موفق: {sent}\n"
    "ناموفق: {failed}"
)
...
ADMIN_TRIAL_STATUS: str = (
    "🎁 VIP آزمایشی یک ساعته\n\n"
    "وضعیت سیستم: {status}\n\n"
    "✅ فعال:\n"
    "کاربران می‌توانند از منوی ربات یک VIP آزمایشی یک ساعته دریافت کنند.\n\n"
    "❌ غیرفعال:\n"
    "دکمه VIP آزمایشی از منوی کاربران مخفی خواهد شد.\n\n"
    "⏳ کاربران Trial فعلی تا پایان زمان خود حذف نخواهند شد و "
    "فقط ثبت‌نام‌های جدید متوقف می‌شود."
)

ADMIN_MINIMUM_PROMPT: str = (
    "💰 حداقل موجودی فعلی: {current} USDT\n\n"
    "حداقل موجودی جدید را به عدد ارسال کنید."
)

ADMIN_MINIMUM_INVALID: str = (
    "❌ مقدار نامعتبر است. یک عدد صفر یا بزرگ‌تر ارسال کنید."
)

ADMIN_MINIMUM_SAVED: str = (
    "✅ حداقل موجودی ورود و ادامه عضویت روی {value} USDT تنظیم شد."
)
